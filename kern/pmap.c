...
//Copyright Sean Eron Anderson 1997-2005 .
//
uint32_t next_power_2(uint32_t v) {
...
i386_vm_init(void)
{
	...
	pages=boot_alloc(npage*sizeof(struct Page), next_power_2(sizeof(struct Page)));
...
page_init(void)
{
	...
	//Then extended memory [EXTPHYSMEM, PADDR(boot_freemem)) which includes kernel image,
